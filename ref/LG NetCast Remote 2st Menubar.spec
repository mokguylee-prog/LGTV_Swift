...
a = Analysis(
    ['/Users/kadelee/Developer/LGTV/lg_remote_template_2st_menubar.py'],
    pathex=[],
    binaries=[],
...
app = BUNDLE(
    coll,
    name='LG NetCast Remote 2st Menubar.app',
    icon='/Users/kadelee/Developer/LGTV/assets/LGNetCast.icns',
    bundle_identifier='com.kadelee.lgnetcast.2st.menubar',
)
